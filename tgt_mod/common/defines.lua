...
NDiplomacy = {
	...
	MAX_CLIENT_STATES = 8,							-- Max client states for one country
...
NCountry = {
	...
	MAXIMUM_CONDOTTIERI = 1,					-- Base number of units you can rent out
	...
	PIETY_PERCENTAGE_AT_NEW_RULER = 1.0,			-- percentage of piety kept at new ruler. #PR Change
	...
	NAT_FOCUS_YEARS_RANK = 0,						-- how many years are removed from nat focus cooldown per gov rank above 1
...
NMilitary = {
	...
	ARMY_ATTRITION_AT_SEA = 5,						-- How many percent attrition units take while loaded onto ships traveling open sea
...
NReligion = {
	...
	CONVERSION_ZEAL_DURATION = 3650,							-- Amount of days in which you cannot convert the province back.
